...
// Styles
import * as S from './AdvertisementsPreview.styles';

// Models
import { AdvertisementsPreviewProps } from './models';
...
const AdvertisementsPreview = ({
    onClose,
    onSelect,
}: AdvertisementsPreviewProps & { onSelect: (type: string, dateStart: string, dateFinish: string) => void }) => {
                ...
                <S.Content>
                    <S.Select>
                        <Select.Action
                            ...
                            options={published}
                        />
                        <Select.Action id="type" label={'Assunto'} onChange={handleTypeChange} value={type} options={subject} />
                    </S.Select>
                    <S.Date>
...
export default AdvertisementsPreview;
