...
// Styles
import * as S from './AdvertisementsForm.styles';

// Models
import { AdvertisementsFormProps } from './models';
...
const AdvertisementsForm = ({
    onClose,
    onSelect,
}: AdvertisementsFormProps & { onSelect: (type: string, dateStart: string, dateFinish: string) => void }) => {
